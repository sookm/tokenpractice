...
contract TuriCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TuriCoin() {
        ...
        name = "TuriCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TUR";                                             // Set the symbol for display purposes (CHANGE THIS)
